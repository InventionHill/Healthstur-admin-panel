                    ...
                    <tbody className={`bg-white divide-y divide-gray-200 ${isSavingOrder ? 'opacity-50 pointer-events-none' : ''}`}>
                        {testimonials.map((testimonial) => (
                            ...
                            >
                                ...
                                <td className={`px-6 py-4 whitespace-nowrap text-right text-sm font-medium sticky right-0 z-10 transition-colors shadow-[-12px_0_15px_-3px_rgba(0,0,0,0.05)] ${dragOverItemId === testimonial.id ? 'bg-blue-50' : 'bg-white group-hover:bg-gray-50'}`}>
